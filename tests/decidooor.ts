...
describe("decidooor", () => {
  ...
  let participant1PublicKey: anchor.web3.PublicKey;
  ...
  before(async () => {
    ...
    [participant1PublicKey] = await anchor.web3.PublicKey.findProgramAddress(
      [
        Buffer.from("participant", "utf-8"),
        participant1Owner.publicKey.toBuffer(),
      ],
      program.programId
    );
  });
